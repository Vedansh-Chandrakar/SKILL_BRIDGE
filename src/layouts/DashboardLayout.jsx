...
const INITIAL_NOTIFICATIONS = [
  { id: 1,  type: 'campus',       title: 'New campus registered',  desc: 'MIT submitted a new campus registration request.',          time: '2 min ago',  read: false },
  { id: 2,  type: 'verification', title: 'Verification pending',   desc: 'Stanford is awaiting identity verification approval.',       time: '1 hr ago',   read: false },
  { id: 3,  type: 'gig',         title: 'Gig flagged',             desc: 'A gig "ML Research Help" was flagged for review.',           time: '3 hr ago',   read: false },
  { id: 4,  type: 'user',        title: 'New user spike',          desc: '156 new users joined in the last 24 hours.',                 time: '5 hr ago',   read: true  },
  { id: 5,  type: 'system',      title: 'System update',           desc: 'Platform maintenance scheduled for Sunday 2 AM.',            time: '1 day ago',  read: true  },
  { id: 6,  type: 'gig',         title: 'Gig completed',           desc: 'Alex Chen completed "Data Analysis" gig successfully.',      time: '1 day ago',  read: true  },
  { id: 7,  type: 'verification', title: 'User verified',          desc: 'Caltech admin account has been identity-verified.',          time: '2 days ago', read: true  },
  { id: 8,  type: 'campus',      title: 'Campus deactivated',      desc: 'Westbrook University account was deactivated by admin.',     time: '2 days ago', read: true  },
  { id: 9,  type: 'user',        title: 'Report submitted',        desc: 'A user filed a report against a recruiter account.',         time: '3 days ago', read: true  },
  { id: 10, type: 'system',      title: 'Backup complete',         desc: 'Weekly platform backup completed successfully.',              time: '4 days ago', read: true  },
];
