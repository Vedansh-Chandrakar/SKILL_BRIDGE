...
const APPLICANT_DATA = {
  'opp-1': {
    ...
    applicants: [
      { id: 'ca-1', name: 'Alex Rivera', email: 'alex@mit.edu', campus: 'MIT', year: 'Junior', major: 'Computer Science', gpa: 3.8, skills: ['React', 'TypeScript', 'Git', 'Tailwind'], rating: 4.8, completedGigs: 15, status: 'pending', appliedAt: '2026-02-22', resume: true, coverLetter: 'Passionate frontend developer with 2+ years of React experience...' },
      { id: 'ca-2', name: 'Jordan Park', email: 'jordan@stanford.edu', campus: 'Stanford', year: 'Graduate', major: 'Software Engineering', gpa: 3.9, skills: ['React', 'TypeScript', 'Next.js'], rating: 4.9, completedGigs: 24, status: 'shortlisted', appliedAt: '2026-02-21', resume: true, coverLetter: 'Graduate student with extensive full-stack experience...' },
      { id: 'ca-3', name: 'Sam Chen', email: 'sam@mit.edu', campus: 'MIT', year: 'Senior', major: 'Design & CS', gpa: 3.6, skills: ['React', 'Figma', 'CSS'], rating: 4.5, completedGigs: 8, status: 'pending', appliedAt: '2026-02-23', resume: true, coverLetter: 'Senior with dual focus in Design and CS...' },
      { id: 'ca-4', name: 'Li Wei', email: 'li@mit.edu', campus: 'MIT', year: 'Junior', major: 'Computer Science', gpa: 3.7, skills: ['JavaScript', 'React', 'Node.js'], rating: 4.7, completedGigs: 9, status: 'rejected', appliedAt: '2026-02-20', resume: false, coverLetter: 'Experienced full-stack developer...' },
      { id: 'ca-5', name: 'Priya Sharma', email: 'priya@stanford.edu', campus: 'Stanford', year: 'Junior', major: 'Computer Science', gpa: 3.85, skills: ['TypeScript', 'React', 'GraphQL'], rating: 4.6, completedGigs: 7, status: 'pending', appliedAt: '2026-02-24', resume: true, coverLetter: 'Full-stack developer with focus on modern JS frameworks...' },
    ],
  },
};
    ...
    <div>
      <PageHeader
        title={
          <div className="flex items-center gap-3">
            ...
            <span>Applicants — {data.role}</span>
          </div>
        }
        subtitle={`${data.company} • ${applicants.length} applicants`}
        actions={
      ...
      <Modal open={showGenerateList} onClose={() => setShowGenerateList(false)} title="Shortlisted Candidates" size="md">
        <div className="space-y-4">
          <p className="text-sm text-gray-500">Below are all shortlisted/accepted candidates for <strong>{data.role}</strong> at {data.company}.</p>
