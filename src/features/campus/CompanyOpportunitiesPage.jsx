...
const OPPORTUNITIES = [
  { id: 'opp-1', company: 'TechCorp Inc.', role: 'Frontend Developer Intern', type: 'Internship', location: 'Remote', salary: '$2,000/mo', description: 'Looking for a talented frontend developer interested in building modern web applications using React and TypeScript.', requirements: ['React', 'TypeScript', 'Git'], deadline: '2026-04-01', postedAt: '2026-02-20', applicants: 18, status: 'active' },
  { id: 'opp-2', company: 'DataFlow Analytics', role: 'Data Analyst', type: 'Full-time', location: 'Cambridge, MA', salary: '$65,000/yr', description: 'Join our analytics team to help derive insights from large datasets using Python and SQL.', requirements: ['Python', 'SQL', 'Statistics'], deadline: '2026-03-25', postedAt: '2026-02-18', applicants: 12, status: 'active' },
  { id: 'opp-3', company: 'DesignHub Studio', role: 'UI/UX Design Intern', type: 'Internship', location: 'New York, NY', salary: '$1,800/mo', description: 'Help create beautiful user experiences for our clients across web and mobile platforms.', requirements: ['Figma', 'UI/UX', 'Prototyping'], deadline: '2026-03-15', postedAt: '2026-02-10', applicants: 24, status: 'active' },
  { id: 'opp-4', company: 'CloudNet Solutions', role: 'Backend Engineer', type: 'Full-time', location: 'San Francisco, CA', salary: '$85,000/yr', description: 'Build scalable APIs and microservices for our cloud infrastructure platform.', requirements: ['Node.js', 'AWS', 'Docker'], deadline: '2026-03-10', postedAt: '2026-02-05', applicants: 9, status: 'closed' },
];
    ...
    <div>
      ...
      <div className="grid gap-4 sm:grid-cols-4 mb-6">
        {[
          ...
          { label: 'Total Applicants', value: opportunities.reduce((a, b) => a + b.applicants, 0), cls: 'text-blue-600', bg: 'bg-blue-50', Icon: UserGroupIcon },
          { label: 'Avg. Applicants', value: Math.round(opportunities.reduce((a, b) => a + b.applicants, 0) / opportunities.length), cls: 'text-amber-600', bg: 'bg-amber-50', Icon: ChartBarIcon },
        ].map((c) => (
          <Card key={c.label}>
      ...
      {/* Opportunities Grid */}
      {filtered.length === 0 ? (
        <EmptyState icon={BuildingOffice2Icon} title="No opportunities found" description="Try adjusting your search or create a new one." />
      ) : (
