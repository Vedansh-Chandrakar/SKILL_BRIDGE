...
/* ── Top Students Data ────────────────────── */
const TOP_STUDENTS = [
  { name: 'Alice Johnson',   campus: 'MIT',      skills: ['React', 'Python', 'Data Science'], rating: 4.9, gigs: 28, available: true,  match: 97, reason: 'Perfect match for your recent Web Dev gigs', badge: 'Top 1%'  },
  { name: 'David Lee',       campus: 'Caltech',  skills: ['PyTorch', 'CUDA', 'Python'],       rating: 4.9, gigs: 15, available: true,  match: 94, reason: 'Ideal for ML & Data gigs you frequently post', badge: 'Verified' },
  { name: 'Bob Williams',    campus: 'Stanford', skills: ['ML', 'Python', 'AWS'],              rating: 4.8, gigs: 24, available: true,  match: 91, reason: 'Strong backend & cloud skills you need',       badge: null       },
  { name: 'Priya Sharma',    campus: 'Stanford', skills: ['React', 'Tailwind', 'TypeScript'],  rating: 4.7, gigs: 19, available: false, match: 88, reason: 'High-quality frontend work, great fit',        badge: null       },
  { name: 'James Okafor',    campus: 'MIT',      skills: ['Node.js', 'PostgreSQL', 'Docker'],  rating: 4.8, gigs: 21, available: true,  match: 86, reason: 'Matches your API & backend skill needs',       badge: 'Hot'      },
  { name: 'Sara Nguyen',     campus: 'Harvard',  skills: ['Figma', 'UX Research', 'Webflow'],  rating: 4.6, gigs: 13, available: true,  match: 83, reason: 'Top designer in campus — suits your branding gigs', badge: null  },
];

/* ── AI Hiring Intelligence ───────────────── */
const TRENDING_SKILLS = [
  { skill: 'AI / LLM Integration', demand: 'Very High', avgBudget: '$650', growth: '+72%', color: 'text-red-600 bg-red-50' },
  { skill: 'TypeScript',           demand: 'High',      avgBudget: '$420', growth: '+38%', color: 'text-indigo-600 bg-indigo-50' },
  { skill: 'React Native',         demand: 'High',      avgBudget: '$480', growth: '+31%', color: 'text-blue-600 bg-blue-50' },
  { skill: 'AWS / Cloud',          demand: 'High',      avgBudget: '$580', growth: '+42%', color: 'text-amber-600 bg-amber-50' },
  { skill: 'Docker / DevOps',      demand: 'Medium',    avgBudget: '$390', growth: '+25%', color: 'text-emerald-600 bg-emerald-50' },
  { skill: 'GraphQL',              demand: 'Medium',    avgBudget: '$350', growth: '+18%', color: 'text-purple-600 bg-purple-50' },
];

const HIRING_TIPS = [
  { tip: 'Post gigs on Monday–Wednesday for 40% more applications in the first 24 hours.',                icon: BoltIcon,           color: 'text-amber-500'  },
  { tip: 'Gigs with clear deliverables get 2.3× more qualified applicants than vague descriptions.',      icon: CheckBadgeIcon,     color: 'text-emerald-500' },
  { tip: 'Budget $300–$500 for web development gigs to attract your campus top 20%.',                    icon: CurrencyDollarIcon, color: 'text-indigo-500' },
  { tip: 'Setting a 2-week deadline (vs. 1 week) increases high-rating applicants by 65%.',              icon: ClockIcon,          color: 'text-blue-500'   },
  { tip: 'Mention specific tech stack in the title — gig views increase by 55%.',                        icon: FireIcon,           color: 'text-red-500'    },
];
...
const RECRUITER_REP = {
  ...
  totalReviews: 9,
  onTimePayments: '100%',
  repeatFreelancers: '67%',
  level: 'Trusted Recruiter',
  nextLevel: 'Elite Recruiter',
  xp: 3100,
  xpNeeded: 4000,
  breakdown: { 5: 7, 4: 1, 3: 1, 2: 0, 1: 0 },
};

const RECRUITER_BADGES = [
  { name: 'First Hire',        icon: CheckBadgeIcon,     description: 'Completed your first successful hire',      color: 'from-emerald-400 to-green-600',  earned: '2025-09-15' },
  { name: 'Fast Payer',        icon: BoltIcon,           description: 'Paid freelancers within 24h every time',    color: 'from-amber-400 to-orange-500',   earned: '2025-11-01' },
  { name: 'Talent Scout',      icon: SparklesIcon,       description: 'Hired 5+ unique freelancers',               color: 'from-indigo-500 to-purple-600',  earned: '2026-01-10' },
  { name: 'Campus Champion',   icon: AcademicCapIcon,    description: 'Posted gigs across 3 campuses',             color: 'from-cyan-400 to-blue-500',      earned: '2026-02-05' },
];

const LOCKED_RECRUITER_BADGES = [
  { name: 'Power Recruiter',  icon: TrophyIcon,      description: 'Post 20 gigs with 4.5+ outcome rating', progress: 12, total: 20 },
  { name: 'Community Builder',icon: UserGroupIcon,   description: 'Hire from 5 different campuses',        progress: 3,  total: 5  },
];

const FREELANCER_REVIEWS_OF_ME = [
  { name: 'Alice Johnson',  rating: 5, text: 'Clear brief, fair budget, and quick payment. Would definitely work with again!',          gig: 'React Dashboard', date: '2026-02-20' },
  { name: 'Bob Williams',   rating: 5, text: 'Great recruiter. Very responsive and provided helpful feedback throughout.',               gig: 'API Backend',     date: '2026-02-10' },
  { name: 'Priya Sharma',   rating: 4, text: 'Good experience overall. Requirements were slightly unclear initially but resolved fast.', gig: 'Landing Page',    date: '2026-01-28' },
];
