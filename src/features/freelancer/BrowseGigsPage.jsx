...
const CATEGORIES = [
  { label: 'All', value: 'all' },
  { label: 'Web Development', value: 'web', count: 8 },
  { label: 'Design & Creative', value: 'design', count: 5 },
  { label: 'Data & Analytics', value: 'data', count: 3 },
  { label: 'Tutoring', value: 'tutoring', count: 4 },
  { label: 'Video & Animation', value: 'video', count: 2 },
  { label: 'Writing', value: 'writing', count: 1 },
  { label: 'Mobile', value: 'mobile', count: 2 },
];

const ALL_GIGS = [
  { id: 'g-10', title: 'Build a Portfolio Website', description: 'Looking for a skilled developer to build a responsive portfolio site with React and Tailwind CSS. Must be mobile-friendly and include a contact form.', budget: 150, tags: ['React', 'Tailwind CSS', 'Frontend'], status: 'open', campus: 'MIT', postedBy: 'Sarah K.', deadline: '2026-03-15', postedAt: '2 hours ago', category: 'web', applicants: 5, urgent: false },
  { id: 'g-11', title: 'Tutoring — Calculus II', description: 'Need a tutor for Calculus II, 3 sessions per week for 4 weeks. Must be available evenings.', budget: 300, tags: ['Tutoring', 'Math'], status: 'open', campus: 'MIT', postedBy: 'Mike T.', deadline: '2026-03-20', postedAt: '5 hours ago', category: 'tutoring', applicants: 3, urgent: false },
  { id: 'g-12', title: 'Video Editing — Campus Event', description: 'Edit a 15-minute highlight video from our annual tech fest footage.', budget: 100, tags: ['Video Editing', 'Premiere Pro'], status: 'open', campus: 'Stanford', postedBy: 'Li W.', deadline: '2026-03-05', postedAt: '1 day ago', category: 'video', applicants: 7, urgent: true },
  { id: 'g-13', title: 'Logo Design for Club', description: 'Need a modern minimalist logo for our university tech club. SVG and PNG deliverables.', budget: 75, tags: ['Design', 'Branding', 'Illustrator'], status: 'open', campus: 'MIT', postedBy: 'Alex R.', deadline: '2026-03-01', postedAt: '1 day ago', category: 'design', applicants: 12, urgent: true },
  { id: 'g-14', title: 'Python Data Analysis Script', description: 'Assist with statistical analysis for a peer-reviewed paper on urban mobility patterns.', budget: 200, tags: ['Python', 'Data Science', 'Stats'], status: 'open', campus: 'Stanford', postedBy: 'Dr. Kim', deadline: '2026-04-01', postedAt: '2 days ago', category: 'data', applicants: 4, urgent: false },
  { id: 'g-15', title: 'Mobile App UI Mockups', description: 'Create Figma mockups for a campus event-booking app. 6 screens minimum with a cohesive color system.', budget: 120, tags: ['Figma', 'UI/UX', 'Mobile'], status: 'open', campus: 'Caltech', postedBy: 'Eva M.', deadline: '2026-03-10', postedAt: '3 days ago', category: 'mobile', applicants: 5, urgent: false },
  { id: 'g-16', title: 'Full-Stack E-commerce Site', description: 'Build a complete e-commerce platform with payment integration, admin panel, and inventory management.', budget: 500, tags: ['React', 'Node.js', 'MongoDB', 'Stripe'], status: 'open', campus: 'Stanford', postedBy: 'Jordan P.', deadline: '2026-04-15', postedAt: '4 hours ago', category: 'web', applicants: 9, urgent: false },
  { id: 'g-17', title: 'Research Paper Editing', description: 'Need a skilled writer to edit and proofread a 20-page research paper on AI ethics.', budget: 60, tags: ['Writing', 'Editing', 'Research'], status: 'open', campus: 'MIT', postedBy: 'Prof. Adams', deadline: '2026-03-08', postedAt: '6 hours ago', category: 'writing', applicants: 2, urgent: false },
  { id: 'g-18', title: 'iOS App Development', description: 'Develop a simple campus navigation app using SwiftUI. Must include map integration and building search.', budget: 350, tags: ['Swift', 'iOS', 'SwiftUI', 'MapKit'], status: 'open', campus: 'Caltech', postedBy: 'Sam C.', deadline: '2026-04-20', postedAt: '1 day ago', category: 'mobile', applicants: 1, urgent: false },
];
