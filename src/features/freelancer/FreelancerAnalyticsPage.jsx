...
import { PageHeader, Card, CardHeader, Badge, StatCard } from '@/components/shared';
import {
  CurrencyDollarIcon,
  DocumentCheckIcon,
  StarIcon,
...
/* ── Mock Data ────────────────────────────────── */
const STATS = [
  { label: 'Total Earnings',  value: '$3,240', change: '+$840 this month',  icon: CurrencyDollarIcon, iconColor: 'bg-emerald-100 text-emerald-600' },
  { label: 'Gigs Completed',  value: '18',     change: '+3 this month',     icon: BriefcaseIcon,      iconColor: 'bg-indigo-100 text-indigo-600'  },
  { label: 'Avg. Rating',     value: '4.8',    change: '+0.1 vs last month', icon: StarIcon,          iconColor: 'bg-amber-100 text-amber-600'    },
  { label: 'Success Rate',    value: '94%',    change: '+2% vs last month',  icon: TrophyIcon,        iconColor: 'bg-purple-100 text-purple-600'  },
];
...
const APPLICATION_HISTORY = [
  { month: 'Sep', applied: 8,  accepted: 5,  rejected: 2 },
  { month: 'Oct', applied: 12, accepted: 8,  rejected: 3 },
  { month: 'Nov', applied: 10, accepted: 7,  rejected: 2 },
  { month: 'Dec', applied: 6,  accepted: 4,  rejected: 1 },
  { month: 'Jan', applied: 14, accepted: 10, rejected: 3 },
  { month: 'Feb', applied: 16, accepted: 12, rejected: 3 },
];
