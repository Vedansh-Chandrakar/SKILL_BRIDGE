...
const initialSkills = ['React', 'JavaScript', 'Tailwind CSS', 'Node.js', 'Python', 'Figma', 'Git'];

const PORTFOLIO_ITEMS = [
  { id: 'p-1', title: 'Campus Event Booking App', description: 'A full-stack event booking platform built with React and Node.js for university events.', image: null, tags: ['React', 'Node.js'], link: 'https://github.com/alexrivera/eventbook', type: 'project' },
  { id: 'p-2', title: 'E-commerce Dashboard', description: 'Admin dashboard with analytics, charts, and real-time order tracking.', image: null, tags: ['React', 'Tailwind', 'Chart.js'], link: 'https://dashboard-demo.vercel.app', type: 'project' },
  { id: 'p-3', title: 'AI Chatbot Interface', description: 'Conversational UI for a GPT-powered tutor chatbot, used by 200+ students.', image: null, tags: ['React', 'OpenAI', 'UI/UX'], link: '', type: 'project' },
];
...
export default function StudentProfilePage() {
  ...
  const [profile, setProfile] = useState({
    ...
    campus: 'MIT',
    mode: 'Freelancer',
    bio: 'Full-stack developer and design enthusiast. I love building intuitive web applications with modern technologies. Open to freelance opportunities in frontend development and UI/UX design.',
          ...
          <div className="flex-1">
            {editing ? (
              ...
              <>
                ...
                <p className="text-sm text-gray-500 mt-0.5">{profile.major} • {profile.year}</p>
            ...
            <div className="mt-3 flex gap-2">
              <Badge color="blue" dot>{profile.mode}</Badge>
              <Badge color="green">Verified</Badge>
              <Badge color="amber">
                <span className="flex items-center gap-1"><StarIcon className="h-3 w-3" /> 4.8</span>
              </Badge>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-xl border border-gray-200 p-3 flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 truncate">Alex_Rivera_Resume_2026.pdf</p>
                <p className="text-xs text-gray-400">Uploaded Feb 15, 2026 • 245 KB</p>
              </div>
