...
const SUBMISSIONS = [
  {
    id: 's-1',
    gigTitle: 'Data Analysis for Research',
    recruiter: 'Dr. Kim',
    status: 'approved',
    submittedAt: '2026-02-28',
    files: ['analysis_report.pdf', 'dataset_cleaned.csv', 'visualization_charts.zip'],
    feedback: 'Excellent work! The analysis was thorough and well-documented. Charts were exactly what I needed.',
    notes: 'Included additional correlation analysis as discussed.',
  },
  {
    id: 's-2',
    gigTitle: 'Mobile App UI Mockups',
    recruiter: 'Eva M.',
    status: 'under_review',
    submittedAt: '2026-03-01',
    files: ['mockups_v2.fig', 'design_system.pdf', 'prototype_link.txt'],
    feedback: '',
    notes: 'Revised based on round 1 feedback — updated color palette and navigation flow.',
  },
  {
    id: 's-3',
    gigTitle: 'Build a Portfolio Website',
    recruiter: 'Sarah K.',
    status: 'revision_requested',
    submittedAt: '2026-02-25',
    files: ['portfolio_site.zip', 'readme.md'],
    feedback: 'Good progress! Please update the contact form — it needs email validation and a success toast. Also add proper meta tags for SEO.',
    notes: 'First submission with all core pages.',
  },
];
        ...
        <div className="space-y-4">
          <div>
            ...
            <select className="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm focus:border-indigo-300 focus:ring-2 focus:ring-indigo-100 focus:outline-none">
              <option>Mobile App UI Mockups — Eva M.</option>
              <option>Build a Portfolio Website — Sarah K.</option>
            </select>
          </div>
