...
export default function AdminProfilePage() {
  ...
  const [profile, setProfile] = useState({
    ...
    email:     user?.email    ?? 'admin@skillbridge.io',
    phone:     user?.phone    ?? '+91 98765 43210',
    role:      'Platform Administrator',
    location:  'Bangalore, India',
    bio:       'Managing the SkillBridge platform — overseeing campuses, users, gigs, and platform integrity.',
    joined:    'January 2025',
    lastLogin: '27 Feb 2026, 10:42 AM',
  });
  ...
  const stats = [
    { icon: BuildingLibraryIcon, label: 'Campuses',   value: '12',  color: 'indigo' },
    { icon: UsersIcon,           label: 'Total Users', value: '4.2k', color: 'purple' },
    { icon: BriefcaseIcon,       label: 'Active Gigs', value: '340', color: 'emerald' },
    { icon: ChartBarIcon,        label: 'Reviews Done', value: '87', color: 'amber'  },
  ];
