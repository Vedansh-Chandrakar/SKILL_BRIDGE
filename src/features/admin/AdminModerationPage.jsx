...
/* ── Mock Data ────────────────────────────────── */
const REPORTS = [
  { id: 'r-1', type: 'gig', title: 'Suspicious Gig: "Easy Money Fast"', reporter: 'Alice Johnson', reporterCampus: 'MIT', target: 'Bob Williams', targetCampus: 'MIT', reason: 'Potential scam / misleading gig description', status: 'pending', severity: 'high', createdAt: '2026-02-25', details: 'The gig promises unrealistic returns and asks for personal payment information outside the platform.' },
  { id: 'r-2', type: 'user', title: 'Harassment Report', reporter: 'Carol Chen', reporterCampus: 'Stanford', target: 'Unknown User#42', targetCampus: 'MIT', reason: 'Inappropriate messages in chat', status: 'investigating', severity: 'high', createdAt: '2026-02-24', details: 'Multiple inappropriate and threatening messages sent through the platform chat system.' },
  { id: 'r-3', type: 'gig', title: 'Plagiarized Work Submission', reporter: 'David Lee', reporterCampus: 'Harvard', target: 'Eva Martinez', targetCampus: 'Caltech', reason: 'Submitted work that appears to be copied from online sources', status: 'resolved', severity: 'medium', createdAt: '2026-02-23', details: 'Code submitted matches publicly available GitHub repositories without attribution.' },
  { id: 'r-4', type: 'review', title: 'Fake Review', reporter: 'Frank Wilson', reporterCampus: 'Yale', target: 'Grace Park', targetCampus: 'Stanford', reason: 'Review appears to be from a fake account', status: 'pending', severity: 'low', createdAt: '2026-02-22', details: 'The reviewing account was created only minutes before leaving the review.' },
  { id: 'r-5', type: 'user', title: 'Multiple Account Violation', reporter: 'System', reporterCampus: 'System', target: 'Henry Adams', targetCampus: 'MIT', reason: 'Same user registered with multiple email addresses', status: 'pending', severity: 'medium', createdAt: '2026-02-22', details: 'IP address analysis shows 3 accounts operating from the same location with similar behavior patterns.' },
  { id: 'r-6', type: 'gig', title: 'Underpaid Work Report', reporter: 'Ivy Chen', reporterCampus: 'Princeton', target: 'Jake Miller', targetCampus: 'MIT', reason: 'Payment significantly below agreed terms', status: 'investigating', severity: 'medium', createdAt: '2026-02-21', details: 'Freelancer completed all deliverables but recruiter marked only partial completion to reduce payment.' },
];

const ACTION_LOGS = [
  { id: 'a-1', admin: 'Super Admin', action: 'Banned user "spammer123"', type: 'ban', time: '2 hours ago', target: 'spammer123' },
  { id: 'a-2', admin: 'Super Admin', action: 'Removed gig "Get Rich Quick"', type: 'delete', time: '4 hours ago', target: 'Get Rich Quick' },
  { id: 'a-3', admin: 'Mod Team', action: 'Warning issued to "Henry Adams"', type: 'warning', time: '6 hours ago', target: 'Henry Adams' },
  { id: 'a-4', admin: 'Super Admin', action: 'Resolved dispute #1042', type: 'resolve', time: '1 day ago', target: 'Dispute #1042' },
  { id: 'a-5', admin: 'Mod Team', action: 'Restored review for "Grace Park"', type: 'restore', time: '1 day ago', target: 'Grace Park' },
  { id: 'a-6', admin: 'Super Admin', action: 'Campus "Caltech" verified', type: 'verify', time: '2 days ago', target: 'Caltech' },
  { id: 'a-7', admin: 'Mod Team', action: 'Flagged 3 suspicious accounts', type: 'flag', time: '2 days ago', target: '3 accounts' },
  { id: 'a-8', admin: 'Super Admin', action: 'Updated platform terms of service', type: 'config', time: '3 days ago', target: 'ToS v2.1' },
];
